...
int main() {
    ll h,w,c,ans=0,t,cnt;
    cin>>h>>w;
    V a(h),b(w),a2(h),b2(w),m(200000,0),m2(200000,0);
    
    rep(i,0,h){
        cin>>a[i];
        if(i!=0){
            a2[i-1]=a[i]-a[i-1];
            //cnt[a[i]-a[i-1]+100000]++;
        }
    }
    rep(i,0,w){
        cin>>b[i];
    ...
    //cout<<m[2+99999-2*2]<<" "<<m[2+99999]<<endl;
    if(w!=1){
        cnt=1;
        c=b2[0];
        rep(i,1,w-1){
            if(c!=0&&c==b2[i]){
                cnt++;
                if(i==w-2){
                    m2[c+100000]=max(cnt,m2[c+100000]);
                }
            }
            else{
                m2[c+100000]=max(cnt,m2[c+100000]);
    ...
    //cout<<m[2+99999-2*2]<<" "<<m[2+99999]<<endl;
    //cout<<*(max_element(all(m)))<<" "<<*(max_element(all(m2)))<<endl;
    rep(i,1,100000){
        ans=max({m[i+100000]+m2[i+100000],m[i+100000]+m2[(i+100000)-(2*i)],ans});
        ans=max({m[(i+100000)-(2*i)]+m2[i+100000],m[(i+100000)-(2*i)]+m2[(i+100000)-(2*i)],ans});
        //cout<<ans<<endl;
    }
